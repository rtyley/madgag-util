...
private SemanticBreakScorer semanticBreakScorer;
  ...
  public diff_match_patch(SemanticBreakScorer semanticBreakScorer) {
	this.semanticBreakScorer = semanticBreakScorer;
  }
  ...
  private int diff_cleanupSemanticScore(String one, String two) {
    return semanticBreakScorer.scoreBreakOver(one,two);
  }
